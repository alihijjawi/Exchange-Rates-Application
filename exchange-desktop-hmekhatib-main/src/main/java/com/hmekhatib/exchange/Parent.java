...
public class Parent implements Initializable, OnPageCompleteListener{
    ...
    public Button tradeforumButton;
    @Override
    ...
    public void insightsSelected() { swapContent(Section.INSIGHTS); }
    public void tradeformSelected() { swapContent(Section.TRADE_FORUM); }
    ...
    private void updateNavigation() {
        ...
        tradeforumButton.setManaged(authenticated);
        tradeforumButton.setVisible(authenticated);
    }
    ...
    private enum Section {
        ...
        public String getResource() {
            return switch (this) {
                case RATES ->
                        "/com/hmekhatib/exchange/rates/rates.fxml";
                case TRANSACTIONS ->
                        "/com/hmekhatib/exchange/transactions/transactions.fxml";
                case LOGIN ->
                        "/com/hmekhatib/exchange/login/login.fxml";
                case REGISTER ->
                        "/com/hmekhatib/exchange/register/register.fxml";
                case INSIGHTS ->
                        "/com/hmekhatib/exchange/insights/insights.fxml";
                case TRADE_FORUM ->
                        "/com/hmekhatib/exchange/trade_forum/trade_forum.fxml";
                default -> null;
            };
        }
